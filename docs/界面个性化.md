<iframe src="//player.bilibili.com/player.html?aid=982315585&bvid=BV1ct4y1H7iS&cid=742278866&page=1&high_quality=1" scrolling="no" border="0" frameborder="no" framespacing="0" allowfullscreen="true" width="100%" height="600"> </iframe>
...
window.$website = {
  isDemo: false,
  autoSave: true,//  自动保存
  autoSaveInterval: 10000,// 默认10秒保存
  isDemoTip: '演示环境不允许操作',
  title: 'DataV 可视化数据大屏',
    ...
    "children": [
      ...
      },
      {
        ...
        option: {
          ...
          "title": "datav",
          "icon": 'icon-datav',
          "img": '/img/assets/datav/datav4.gif',
          "dataType": 0,
          "dataMethod": 'get',
          "data":{
            "points": [
